...
describe("PostServiceTest", function() {
	...
	it("Should list all posts by category", function(done) {
		...
		postService.listByCategory('animation', function(posts){
	...
	it("Should list all posts by another category", function(done) {
		...
		postService.listByCategory('movies', function(posts){
	        expect(expectedPostsFromCategory).toEqual(posts);
			done();
	    });
	...
	it("Should get a post by id", function(done) {
		...
		postService.getById(1, function(post){
	...
	it("Should get another post by id", function(done) {
		...
		postService.getById(2, function(post){
	        expect(expectedPost).toEqual(post);
			done();
	    });
	...
	it("Should get a post by search", function(done) {
		...
		postService.getBySearch('Empire', function(resultSearch){
	...
	it("Should get a post by search a category", function(done) {
		...
		postService.getBySearch('movies', function(resultSearch){
	        expect(expectedResultSearch).toEqual(resultSearch);
			done();
	    });
